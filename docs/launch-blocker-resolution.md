...
- Live build version: `20260630-release-room-reporting`.
...
- Pilot write gate last passed on 2026-06-30 with live form writes, 12 event writes, inbox delivery required, dedicated pilot feedback routing, fan-reaction reporting, release-room retention reporting, signal-pass export coverage, protected activation-readiness reporting, and post-write reconciliation through the protected operator report. QA run ID: `20260630161012`. Asset version: `20260630-release-room-reporting`.
