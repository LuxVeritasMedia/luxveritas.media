...
- Live build version: `20260620-brand-house-rail`.
...
- Inbox provider closeout is resolved: 2026-06-20 pilot write gate confirmed 11 capture intents with inbox delivery required.
