...
Run the local MVP preflight when you want one no-secret command for operator environment, deploy status, launch-blocker sync, approval decision forms, MVP status, and release-readiness signals:
