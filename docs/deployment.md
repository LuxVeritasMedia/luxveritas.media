...
Once the sending domain is verified, set the values on the deployed Cloud Run service generated by Firebase Functions, then redeploy or restart the function:
