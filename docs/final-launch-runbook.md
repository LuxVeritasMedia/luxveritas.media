...
- Current asset version is `20260620-workflow-targets`.
- Current phase status is Phase 5 portal pilot prep, with Phase 4 legal closeout still open.
- Media, inbox delivery, private handoff, operator reporting, and private workflow-target recommendation reporting are ready.
