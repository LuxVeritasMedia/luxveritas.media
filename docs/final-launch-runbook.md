...
- Current asset version is `20260705-cache-refresh`.
...
Inbox delivery was last confirmed by the 2026-07-05 pilot write gate, QA run ID `20260705120526`, with 11 live capture intents, 13 event writes, and inbox delivery required. Current pilot evidence asset version: `20260705-cache-refresh`. Re-run the live form matrix only if sender domain, provider secret, Functions deployment, or final release evidence freshness changes:
