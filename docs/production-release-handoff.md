...
- Current live asset version: `20260630-open-approvals-report`
...
Inbox delivery was confirmed by the 2026-06-30 pilot write gate, QA run ID `20260630181531`, with 11 live capture intents, 13 event writes, and inbox delivery required. Current pilot evidence asset version: `20260630-open-approvals-report`. Re-run this only if the sender domain, provider secret, Functions deployment, or final release evidence freshness changes:
