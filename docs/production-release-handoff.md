...
- Current live asset version: `20260704-portal-access-path`
...
Inbox delivery was confirmed by the 2026-07-05 pilot write gate, QA run ID `20260705114236`, with 11 live capture intents, 13 event writes, and inbox delivery required. Current pilot evidence asset version: `20260704-portal-access-path`. Re-run this only if the sender domain, provider secret, Functions deployment, or final release evidence freshness changes:
