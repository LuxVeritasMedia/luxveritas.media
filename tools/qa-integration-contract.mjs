...
expectEqual(payload.legal.publicTermsVersion, "2026-07-03-public-capture", "payload public terms version");
expectEqual(payload.legal.privacyVersion, "privacy-draft-2026-07-03", "payload privacy version");
