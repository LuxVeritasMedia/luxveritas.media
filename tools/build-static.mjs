...
function formDialog() {
  ...
  <form action="/api/submit" method="post" class="dialog-shell" data-form-endpoint="/api/submit">
    ...
    <label><span>Inquiry type</span><select name="inquiry_type" required>
      <option value="">Select one</option><option>Membership</option><option>Submissions</option><option>Events</option><option>Press</option><option>Partnership</option><option>Licensing</option><option>Investor</option><option>Portal</option><option>Pilot Feedback</option><option>General</option>
    </select></label>
  ...
  return `<section class="section fan-signal-section" data-fan-signal>
    ...
    <div class="fan-signal-panel" aria-label="Your Lux Veritas signal">
      ...
      <div class="fan-signal-actions">
        ...
        <button class="button button-quiet" type="button" data-fan-signal-export>Save signal pass</button>
  ...
  return shell({
    ...
    <section class="section report-panel" data-private-report>
      ...
      <div class="report-grid" aria-label="Private activity totals">
        ...
        <article><span>Accepted Handoffs</span><strong data-private-count="privateHandoffs">-</strong><small>Signed bridge receipts</small></article>
      ...
      <div class="report-detail report-summary">
        ...
        <div>
          <p class="kicker">Handoff Records</p>
          <ul class="report-list" data-private-summary="handoffs"><li>Load private activity to view accepted handoffs.</li></ul>
        </div>
        <div>
